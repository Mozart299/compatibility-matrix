          ...
          <div className="w-full md:w-auto flex justify-end">
            {editMode ? (
              <div className="flex gap-2 w-full md:w-auto">
                <Button variant="outline" size="sm" onClick={() => setEditMode(false)} className="flex-1 md:flex-auto text-xs sm:text-sm">
                  Cancel
                </Button>
                <Button size="sm" onClick={handleSaveProfile} className="flex-1 md:flex-auto text-xs sm:text-sm">
          ...
          <Card>
            <CardHeader className="text-center p-4 sm:p-6">
              ...
              {editMode ? (
                ...
                <>
                  <CardTitle className="text-lg sm:text-xl">{userData.name}</CardTitle>
                  <CardDescription className="text-xs sm:text-sm">{userData.location}</CardDescription>
                </>
              )}
            </CardHeader>
            <CardContent className="px-4 sm:px-6 py-3 sm:py-4 space-y-3 sm:space-y-4">
              ...
              <div className="pt-1 sm:pt-2">
                ...
                <p className="text-xs sm:text-sm">{new Date(userData.joinedDate).toLocaleDateString()}</p>
              </div>

              {userData.personalityType && (
                <div className="pt-1 sm:pt-2">
                  <p className="text-xs sm:text-sm text-muted-foreground mb-1 sm:mb-2">Personality Type</p>
                  <Badge className="bg-blue-500 text-xs">{userData.personalityType}</Badge>
                </div>
              )}
                ...
                <Card>
                  ...
                  <CardContent className="px-4 sm:px-6 py-3 sm:py-4">
                    {editMode ? (
                      ...
                      <p className="text-xs sm:text-sm text-muted-foreground">{userData.bio}</p>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label htmlFor="profile-visibility" className="text-xs sm:text-sm font-medium">
                          Profile Visibility
                        </Label>
                        <p className="text-[10px] sm:text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label htmlFor="show-email" className="text-xs sm:text-sm font-medium">
                          Show Email Address
                        </Label>
                        <p className="text-[10px] sm:text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label htmlFor="show-location" className="text-xs sm:text-sm font-medium">
                          Show Location
                        </Label>
                        <p className="text-[10px] sm:text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label htmlFor="allow-messaging" className="text-xs sm:text-sm font-medium">
                          Allow Messaging
                        </Label>
                        <p className="text-[10px] sm:text-xs text-muted-foreground">
                  ...
                  {editMode && (
                    <CardFooter className="px-4 sm:px-6 py-3 sm:py-4">
                      <Button className="w-full text-xs sm:text-sm" onClick={handleSaveProfile}>
