                      ...
                      {compatibilityData.challenges.map((challenge, index) => (
                        <li key={index} className="flex gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs sm:text-sm text-muted-foreground">
                              Score: {challenge.score}% - {challenge.description || "You may need to navigate differences in this area"}
                            </p>
                          </div>
                        </li>
                      ))}
                ...
                {interestsData.shared.length > 0 || interestsData.user.length > 0 || interestsData.other.length > 0 ? (
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1">
                      <h3 className="font-medium text-base sm:text-lg mb-3">{compatibilityData.other_user.name}'s Unique Interests</h3>
                ...
                {compatibilityData.detailed_analysis?.communication_dynamics ? (
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="border rounded-lg p-3 sm:p-4">
                        <h3 className="font-medium mb-2 text-sm sm:text-base">{compatibilityData.other_user.name}'s Style</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <span className="text-xs sm:text-sm">Understanding each other's communication style helps build stronger connections</span>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <span className="text-xs sm:text-sm">Be mindful of differences in communication preferences</span>
                        </div>
                      </div>
                    </div>
                  </div>
                          ...
                          {compatibilityData.detailed_analysis.values_alignment.map((value, index) => (
                            <div key={index} className="flex items-center gap-2">
                              <div className={`w-2 h-6 rounded-full ${
                                value.alignment > 70 ? "bg-green-500" : 
                                value.alignment > 40 ? "bg-yellow-500" : 
                                "bg-red-500"
                              }`} />
                          ...
                          <div className="flex items-center gap-2">
                            <div className="w-full bg-gray-200 rounded-full h-2.5">
                              <div className="bg-blue-600 h-2.5 rounded-full" style={{ 
                                width: `${compatibilityData.dimension_scores.find(d => d.dimension_id === 'values')?.score || 0}%` 
                              }}></div>
                            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="border rounded-lg p-4 flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">Complete all assessments to get a more accurate compatibility score.</p>
